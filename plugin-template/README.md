...
2. Edit the `.claude-plugin` file with your plugin details
...
- `.claude-plugin` - Plugin metadata (edit this with your details)
...
1. Update the `name` field in `.claude-plugin` to match your directory name
